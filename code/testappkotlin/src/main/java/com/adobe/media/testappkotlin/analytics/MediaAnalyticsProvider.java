...
import com.adobe.media.testappkotlin.player.*;
...
public class MediaAnalyticsProvider implements Observer {
    ...
    public MediaAnalyticsProvider(VideoPlayer player) {
        ...
        config.put(MediaConstants.TrackerConfig.CHANNEL, "android_kotlin_sample"); // Overwrites channel configured from remote configuration
